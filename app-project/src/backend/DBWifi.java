...
public class DBWifi {
    ...
    static {
        ...
        databaseWifi.add(new ArrayList<>(Arrays.asList("E5:F6:G7:H8", "Budi Jatmiko", "10 MB", "Limit", "14:00")));
        databaseWifi.add(new ArrayList<>(Arrays.asList("BC:D1:12:F5", "Siti Aminah", "10 MB", "DIBLOKIR", "14:00")));
